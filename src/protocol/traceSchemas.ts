...
export const treeCheckBoundsCommandSchema = z
  .object({
    ...
    type: z.literal('tree.checkBounds'),
    nodeId: nodeIdSchema,
...
export const treeSetDepthCommandSchema = z
  .object({
    ...
    type: z.literal('tree.setDepth'),
    nodeId: nodeIdSchema,
    depth: z.number().int().positive().max(TRACE_LIMITS.collectionItems),
  })
  .strict();
...
export const traceCommandSchema = z.discriminatedUnion('type', [
  ...
  treeCheckBoundsCommandSchema,
  treeSetDepthCommandSchema,
